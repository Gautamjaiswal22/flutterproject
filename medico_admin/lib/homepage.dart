...
import 'package:medico_admin/allproducts.dart';
import 'cart.dart';
          ...
          children: [
            const DrawerHeader(
              ...
              child: UserAccountsDrawerHeader(
                decoration:
                    BoxDecoration(color: Color.fromARGB(255, 245, 0, 0)),
                accountName: Text(
                  "GAUTAM",
                ...
                currentAccountPicture: CircleAvatar(
                  backgroundColor: Color.fromARGB(255, 12, 207, 51),
                  child: Text(
                    "G",
                    style: TextStyle(
                        fontSize: 30.0, color: Color.fromARGB(255, 5, 5, 4)),
                  ), //Text
                ), //circleAvatar
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => orders_user()));
              },
            ),
            ListTile(
